...
std::shared_ptr<Actor> HaroldFactory::Create(std::wstring imagesDir)
{
    ...
    ////////////// Added Prop ////////////////////////////////////
    auto bingus = make_shared<ImageDrawable>(L"Bingus", imagesDir + L"/bingus.png");
    bingus->SetCenter(wxPoint(35, 50));
    bingus->SetPosition(wxPoint(0, 10));
    lhand->AddChild(bingus);
